      ...
      <div className='flex justify-between items-center  h-20 wrapper relative'>
        ...
        >
          <ul className='lg:flex max-lg:flex-col max-lg:h-full gap-10 justify-between shadow-sm shadow-blue p-5 rounded-xl'>
            ...
            <li className='max-lg:text-right max-lg:my-5'>
              <Link href='/#about' className='text-text_light/40 '>
                About
              </Link>
            </li>

            <li className='max-lg:text-right max-lg:my-5'>
              <Link href='/#projects' className='text-text_light/40 '>
                Projects
              </Link>
            </li>
            <li className='max-lg:text-right max-lg:my-5'>
              <Link href='/#blog' className='text-text_light/40'>
                Blog
              </Link>
            </li>
            <li className='text-right '>
              <Link href='/#contact-me' className='text-text_light/40 '>
                Contact me
              </Link>
            </li>
          </ul>
